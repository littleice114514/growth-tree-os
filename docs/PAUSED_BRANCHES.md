...
- 顶部工具栏已暴露 `图谱 V1` 入口，见 `app/renderer/src/components/Toolbar.tsx`。
- 主页面已能按 `currentView === 'obsidianGraph'` 渲染 `ObsidianGraphView`，见 `MainWorkspacePage.tsx`。
